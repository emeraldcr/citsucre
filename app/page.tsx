...
export default function RainforestTourismCenter() {
  const [isMenuOpen, setIsMenuOpen] = useState(false)

  const adventures = [
    {
      title: "Rainforest Canopy Tour",
      description: "Experience the treetops with our zip-line adventure through the cloud forest canopy",
      duration: "3-4 hours",
      difficulty: "Moderate",
      price: "$65",
      image: "/placeholder.svg?height=300&width=400",
      highlights: ["7 zip-line platforms", "Wildlife spotting", "Professional guides"],
    },
    {
      title: "Waterfall Hiking Trail",
      description: "Discover hidden waterfalls and natural pools in the heart of the rainforest",
      duration: "5-6 hours",
      difficulty: "Challenging",
      price: "$45",
      image: "/placeholder.svg?height=300&width=400",
      highlights: ["3 spectacular waterfalls", "Swimming opportunities", "Lunch included"],
    },
    {
      title: "Bird Watching Tour",
      description: "Spot over 200 species of tropical birds including the famous Quetzal",
      duration: "4-5 hours",
      difficulty: "Easy",
      price: "$55",
      image: "/placeholder.svg?height=300&width=400",
      highlights: ["Professional ornithologist guide", "High-quality binoculars", "Bird identification book"],
    },
    {
      title: "Night Wildlife Safari",
      description: "Explore the nocturnal wonders of the rainforest with expert naturalist guides",
      duration: "3 hours",
      difficulty: "Easy",
      price: "$40",
      image: "/placeholder.svg?height=300&width=400",
      highlights: ["Nocturnal animals", "Professional flashlights", "Small groups only"],
    },
  ]
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-6">
            ...
            <span className="block text-green-400">Rainforest Paradise</span>
          </h1>
